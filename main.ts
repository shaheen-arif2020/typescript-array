//Question 1: Create an array named fruits that contains the following
...
console.log(numbers);
/*Question 3: Access the third element of the fruits array and assign it
to a variable named thirdFruit.*/
const thirdFruit = fruits[2];
console.log(thirdFruit);
/* Question 4: Change the second element of the numbers array to 25. */
numbers[1] = 25;
console.log(numbers);
/* Question 5: Add the element "grape" to the end of the fruits array
 using the method. */
fruits.push("grapes");
console.log(fruits);
...
console.log(fruits);
/* Question 8
Add the element "kiwi" to the beginning of the fruits array using the
 method. */
fruits.unshift("kiwi");
console.log(fruits);
/* Question 9
Remove 2 elements from the fruits array starting from index 1 using
 the method. */
 fruits.splice(1, 2);
 console.log(fruits);
